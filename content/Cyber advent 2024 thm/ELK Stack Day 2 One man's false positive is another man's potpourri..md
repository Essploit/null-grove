...
Once the machine is up and running, we can connect to the Elastic SIEM by visiting [https://LAB_WEB_URL.p.thmlabs.com](https://LAB_WEB_URL.p.thmlabs.com) in your browser using the following credentials:
